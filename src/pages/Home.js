    ...
    <>
      ...
      <div>
        <div
          ...
          <div className='container px-5 mt-20-mobile'>
            <div className='row h-100'>
              <div className='col-7 my-auto'>
                <div className='my-2 display-3 fw-bold fade-in-text'>
                  Taqneeq
                </div>
            ...
            <div className='mt-5 mouse-pointer' onClick={routeChange}>
              <div className='row fade-in-text delayed1'>
                ...
                <div className='col-9 col-md-4'>
                  ...
                  <div className=''>
                    Memories, Fun, Technical events, Innovative Experience. You
                    name it we have it.
                  </div>
                </div>
              </div>
          ...
          <div className='col-3 col-md-2 align-self-end fade-in-text delayed'></div>
        </div>
      </div>
    </>
  );
